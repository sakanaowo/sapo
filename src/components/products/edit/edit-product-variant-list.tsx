...
interface EditProductVariantListProps {
    variants: Variant[];
...
const EditProductVariantList: React.FC<EditProductVariantListProps> = ({
    variants,
    selectedVariantId,
}) => {
    const { setSelectedVariant } = useEditProductStore();
...
export default EditProductVariantList;
